...
| Map overlay | `Sources/PebbleCore/Game/MapOverlay.swift`, `Sources/Pebble/MapOverlayM.swift`, `Sources/Pebble/HudM.swift`, `Sources/Pebble/ScreensM.swift` | Reads only loaded in-memory chunk height/top-block data; maximum zoom-out is bounded to the currently loaded chunk extent, zoom-in bottoms out at about 100 blocks, and app-side drawing caps minimap/full-map sample resolution so a large loaded world cannot create unbounded UI work |
