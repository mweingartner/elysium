---
name: Bug report
about: Something broken? Reports mean the world to us — thank you.
title: ""
labels: bug
assignees: ""
---
...
<!-- What you did, what happened, and what you expected instead.
     Rough steps to reproduce are fine — anything helps. -->
...
## World context (for in-world bugs)

- Seed:
- Dimension + coordinates (the F3 overlay shows these):
