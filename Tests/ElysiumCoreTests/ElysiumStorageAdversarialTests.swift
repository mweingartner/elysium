...
final class ElysiumStorageAdversarialTests: XCTestCase {
    ...
    func testReleaseSurfaceVerifierIsExecutableFailClosedAndIntegrated() throws {
        ...
        for required in [
            ...
            "ElysiumStorage.ElysiumStorageCoordinator.open(databaseURL:",
            "_sqlite3_close_v2",
        ...
        guard let firstReceipt = prePush.range(of: "installed-signoff-receipt.sh prepush"),
              ...
              let hookVerifier = prePush.range(
                of: "verify-elysium-storage-release-surface.sh",
        ...
        XCTAssertLessThan(hookTests.lowerBound, hookElysmoke.lowerBound)
        XCTAssertLessThan(hookElysmoke.lowerBound, secondReceipt.lowerBound)
    }
