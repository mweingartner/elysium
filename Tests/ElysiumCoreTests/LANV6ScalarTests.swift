...
final class LANV6ScalarTests: XCTestCase {
    ...
    func testRegistryIDRequiresValidShapeAndClosedRegistryMembership() throws {
        ...
        let allowed: Set<String> = ["elysium:stone", boundary]
        XCTAssertEqual(try LANV6RegistryID("elysium:stone", allowedIDs: allowed).value,
                       "elysium:stone")
        ...
        XCTAssertThrowsError(try LANV6RegistryID("elysium:dirt", allowedIDs: allowed))
    }
