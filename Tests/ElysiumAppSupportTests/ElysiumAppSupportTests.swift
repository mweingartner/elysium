import XCTest
@testable import ElysiumAppSupport

final class ElysiumAppSupportTests: XCTestCase {
    ...
    func testLaunchRevealRequestsExactlyOnceForEitherValidInactiveKind() {
        for kind in [ElysiumLaunchRevealKind.fullscreen, .windowedFallback] {
            var state = ElysiumLaunchActivationState(windowIdentity: 7, generation: 9)
    ...
    func testLaunchRevealEveryInvalidOrTransitionalPredicateFailsClosed() {
        let invalid: [ElysiumLaunchRevealPredicates] = [
    ...
    func testExhaustedDispositionMatrix() {
        let latch = ElysiumAppInputExhaustionLatch()
    ...
    func testStructuralKeySeparatesEveryIdentityDimension() {
        let value = ElysiumRetainedDescriptorKey(id: "a", role: "cell", parentID: "root", actionable: true, focusable: true)
        let base = ElysiumRetainedStructureKey(screenIdentity: 1, generation: 2, orderedDescriptors: [value])
        ...
        for changed in [
            ElysiumRetainedDescriptorKey(id: "b", role: "cell", parentID: "root", actionable: true, focusable: true),
            ElysiumRetainedDescriptorKey(id: "a", role: "button", parentID: "root", actionable: true, focusable: true),
            ElysiumRetainedDescriptorKey(id: "a", role: "cell", parentID: "other", actionable: true, focusable: true),
            ElysiumRetainedDescriptorKey(id: "a", role: "cell", parentID: "root", actionable: false, focusable: true),
            ElysiumRetainedDescriptorKey(id: "a", role: "cell", parentID: "root", actionable: true, focusable: false),
    ...
    func testRetainedTreeStorePreservesReferencesForScalarsAndReplacesEveryStructure() {
        final class Node {}
        let descriptor = ElysiumRetainedDescriptorKey(
            id: "a", role: "cell", parentID: "root", actionable: true, focusable: true)
        let base = ElysiumRetainedStructureKey(
            screenIdentity: 1, generation: 2, orderedDescriptors: [descriptor])
        let store = ElysiumRetainedTreeStore<Node>()
        let original = Node()
        ...
        let structuralKeys = [
            ElysiumRetainedStructureKey(screenIdentity: 9, generation: 2, orderedDescriptors: [descriptor]),
            ElysiumRetainedStructureKey(screenIdentity: 1, generation: 9, orderedDescriptors: [descriptor]),
            ElysiumRetainedStructureKey(screenIdentity: 1, generation: 2, orderedDescriptors: [
