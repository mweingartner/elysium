...
private final class ProbeDependencies: ReleaseGateCommandDependencies {
    ...
    func installAndObserve(
        ...
        let staged = context.stagedBundle.appendingPathComponent("Contents/MacOS/Pebble")
        ...
        let requirement = "identifier \"com.briangao.pebble\""
    ...
    func captureInstalledObservation(
        ...
        for index in 1...14 {
            ...
            let command: [String: Any] = [
                "schema": "PebbleInstalledCommandEvidenceV1", "commandID": "fixture-\(index)",
    ...
    private func makeContext() -> ReleaseGateWorkflowContext {
        ...
        return .init(
            ...
            releaseExecutable: URL(fileURLWithPath: bin).resolvingSymlinksInPath()
                .appendingPathComponent("Pebble"),
            stagedBundle: repository.appendingPathComponent("dist/Pebble.app"),
            installedBundle: executable.deletingLastPathComponent(),
            installedExecutable: executable, bundleID: "com.briangao.pebble",
            expirySeconds: 600)
    }
