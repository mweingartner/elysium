...
pub enum WorldFormat {
    ...
    LuantiWorld,
    /// Elysium's bounded, versioned exchange directory.
    ElysiumExchange,
}
...
impl<'a> WorldEditor<'a> {
    ...
    pub fn place_wall_banner(
        ...
        match self.format() {
            ...
            | crate::world_editor::WorldFormat::ElysiumExchange => {}
        }
    }
    ...
    pub fn save(&mut self) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        println!(
            ...
            match self.format {
                ...
                WorldFormat::ElysiumExchange => "Elysium Reality Exchange",
            }
        );
        ...
        match self.format {
            ...
            WorldFormat::LuantiWorld => {
                #[cfg(not(feature = "luanti"))]
                return Err("This Arnis build does not include Luanti output.".into());
                #[cfg(feature = "luanti")]
            ...
            WorldFormat::ElysiumExchange => {
                elysium::save_elysium_exchange(
                    &self.world,
                    &self.world_dir,
                    self.xzbbox,
                    &self.llbbox,
