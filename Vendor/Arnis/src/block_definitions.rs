...
impl Block {
    ...
    /// Elysium exchange serialization rebuilds the compact section id while preserving
    /// Arnis' canonical block-name mapping.
    #[inline(always)]
    pub(crate) const fn from_raw_id_for_exchange(id: u16) -> Self {
        Self::new(id)
    }
