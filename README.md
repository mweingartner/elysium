...
`elysmoke` is the deterministic golden contract and is expected to report 488 passing checks unless a reviewed behavior change deliberately updates that contract.
...
4. Full XCTest.
5. The 488-check `elysmoke` golden suite.
