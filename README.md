...
Sources/PebbleCore/   the engine — headless, no AppKit, fully testable
  ...
  Net/                LAN protocol messages, bounded frame codec, validation
...
- [LAN_MULTIPLAYER_PLAN.md](LAN_MULTIPLAYER_PLAN.md) — local-network multiplayer design/security plan and remaining replication work.
