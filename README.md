...
- **Items & systems** — shaped/shapeless/tag crafting with recipe menus that auto-fill available ingredients and output-slot arrows for choosing multi-craft quantities, crafting tables that can draw from containers within 25 blocks, smelting in three furnace types, brewing, enchanting with 39 enchantments and a compatibility matrix, anvils, grindstones, smithing with armor trims, stonecutters, loot tables with fortune/looting, fishing, archaeology with sherds and decorated pots, advancements.
