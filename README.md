...
- **World creation choices** — Default, Superflat, Large Biomes, Amplified, Single Biome, Debug, Elysium's Rich Resources preset, **Nether World**, and four versioned **Prehistoric Worlds** profiles (Lost World, Jurassic Giants, Cretaceous Frontiers, and Ancient Seas), plus **Reality Derived** maps built from a player-selected real-world area through the bundled Arnis generator. World creation emits the current v3 prehistoric profiles while explicit v1/v2 saves retain their original terrain and combat contract. Prehistoric Worlds are opt-in: they use a 36-creature native roster for their natural population, suppress ordinary hostile and domestic population including legacy structure spawners and occupants, and exclude human village/outpost plans without changing ordinary saves or normal-world generation. Every current prehistoric map begins inside a roofed oak starter hut with a bed, crafting table, world-seeded small tool/resource/food chest, and a fixed nearby oak grove; current land predators hunt herd herbivores while defenders rally, but classic v1 maps retain their established behavior. Nether World begins in a safe active-portal chamber with two iron pickaxes, an iron sword, an iron shovel, and 64 oak logs; active gateways recur throughout its Nether. Every type offers Small (1 km), Medium (4 km), Large (8 km), Extra-Large (12 km), and Max (15.811 km) playable widths with lazy terrain generation; Reality Derived Max reaches the local Arnis 250 km² envelope. Where a generator can honor it, creation exposes independent five-level dungeon and village densities; village choices are None, Few, Normal, Many, and Max. Superflat retains villages but omits its nonfunctional dungeon selector. See [Prehistoric Worlds](docs/PREHISTORIC_WORLDS.md) for the compatibility, asset, and evidence policy.
- **Caves and volcanic landscapes** — Rich Resources retains its ore-rich rolling hills while offering more caves and underground lava regions. New v3 dinosaur maps add wider caves, more tunnels and ravines, broader underground lava regions, and occasional small dry-land volcanoes with exposed crater lava. Volcanoes avoid the starter hut/grove and existing structures; Ancient Seas keeps its ocean water. Older dinosaur revisions keep their original generation. Saved full-block chunks remain intact; unmodified Rich Resources areas saved only as entity records can regenerate with the richer geology.
