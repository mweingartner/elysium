...
The release build must be warning-free. `elysmoke` is the golden contract and must report the expected 488 checks passing unless the project deliberately changes that count in the same reviewed change.
