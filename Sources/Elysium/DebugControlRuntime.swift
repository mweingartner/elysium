            ...
            case .renderer:
                ...
                sections[scope.rawValue] = .object([
                    ...
                    "rayTracing": .object([
                        ...
                        "residentGeometryBytes": .integer(Int64(ray.residentGeometryBytes)),
                        "transientGeometryBytes": .integer(Int64(ray.transientGeometryBytes)),
                        "memoryBudgetBytes": .integer(Int64(ray.memoryBudgetBytes)),
                        "deviceAllocatedBytes": .integer(Int64(ray.deviceAllocatedBytes)),
                        "deviceRecommendedBytes": .integer(Int64(ray.deviceRecommendedBytes)),
                        "width": .integer(Int64(ray.width)), "height": .integer(Int64(ray.height)),
                        "outputWidth": .integer(Int64(ray.outputWidth)), "outputHeight": .integer(Int64(ray.outputHeight)),
                        "historySamples": .integer(Int64(ray.historySamples)),
                        "gpuMilliseconds": .number(ray.gpuMilliseconds),
                        "gpuStageMilliseconds": .object(ray.gpuStageMilliseconds.mapValues { .number($0) }),
                        "gpuStageFrameIndex": .integer(Int64(clamping:ray.gpuStageFrameIndex)),
                        "denoiser": .string(ray.denoiser),
                        "historyResets": .object(ray.historyResets.mapValues { .integer(Int64($0)) }),
                        "fallbackFrames": .object(ray.fallbackFrames.mapValues { .integer(Int64($0)) }),
                        "deferredSections": .integer(Int64(ray.deferredSections)),
                        "staleSections": .integer(Int64(ray.staleSections)),
                        "truncatedSections": .integer(Int64(ray.truncatedSections)),
                        "locallyInvalidatedInstances": .integer(Int64(ray.locallyInvalidatedInstances)),
                        "builtSections": .integer(Int64(ray.builtSections)),
                        "builtTriangles": .integer(Int64(ray.builtTriangles)),
                        "compactedSections": .integer(Int64(ray.compactedSections)),
                        "compactionSavedBytes": .integer(Int64(ray.compactionSavedBytes)),
