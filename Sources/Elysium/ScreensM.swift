...
// scripting-editor-ui: the retired game-canvas ScriptEditorScreen used to live here
// (script-runtime change 1c / scripting-ui-and-replication change 3). Replaced by the native
// SwiftUI script editor (Sources/Elysium/ScriptEditorUI/) — see ScriptEditorWindowController,
// ScriptEditorModel, and ScriptEditorView. `/script edit` (CommandsM.swift) and the Inspector
// "Edit Script" button (InspectorScreen.swift) now open that window directly.
// =============================================================================
