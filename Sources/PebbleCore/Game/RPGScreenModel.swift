...
public func rpgAuthorityPhasePresentation(_ phase: RPGAuthorityPresentationPhase) -> RPGAuthorityPhasePresentation {
    ...
    case .committingAcceptedOwnerCheckpoint:
        ...
        help = "Character changes are disabled while Pebble saves the accepted host update. Local quick slots remain available."
        disabled = help
    case .committingRejectedOwnerCheckpoint:
        icon = "authority.savingRejected"; title = "Restoring host state"
        help = "Character changes are disabled while Pebble restores the host’s character state. Local quick slots remain available."
        disabled = help
    case .reconnecting:
    ...
    case .awaitingDispositionCheckpoint:
        ...
        help = "Character changes are disabled while Pebble finishes processing the host response. Local quick slots remain available."
        disabled = help
