...
@MainActor
final class PebbleAccessibilityElement: NSAccessibilityElement {
...
final class RPGAccessibilityBridge {
    ...
    private var currentElements: [PebbleAccessibilityElement] = []
    private var rootElements: [PebbleAccessibilityElement] = []
    private let retainedStore = PebbleRetainedTreeStore<PebbleAccessibilityElement>()
    ...
    private func structuralKey(_ value: RPGAccessibilityTreeSnapshot)
        ...
        PebbleRetainedStructureKey(
            ...
            orderedDescriptors: value.elements.map { element in
                ...
                return PebbleRetainedDescriptorKey(
    ...
    func isFocused(_ element: PebbleAccessibilityElement) -> Bool {
    ...
    @discardableResult
    func focus(_ element: PebbleAccessibilityElement) -> Bool {
    ...
    func retainedFocusedElement() -> PebbleAccessibilityElement? {
        let focused = currentElements.filter { isFocused($0) }
        return focused.count == 1 ? focused[0] : nil
    }

    @discardableResult
    func press(_ element: PebbleAccessibilityElement) -> Bool {
